select COUNT(*) from ss_rs_ts_aut_ap_digital_schema.DWS_Finance_FPA_ARBAD_ARBADSales_Combination
call  ss_rs_ts_aut_ap_digital_schema.sp_Finance_FPA_ARBAD_DWD_to_DWS_Combination()
CREATE OR REPLACE PROCEDURE ss_rs_ts_aut_ap_digital_schema.sp_Finance_FPA_ARBAD_DWD_to_DWS_Combination()
LANGUAGE plpgsql
AS $$
BEGIN

delete ss_rs_ts_aut_ap_digital_schema.DWS_Finance_FPA_ARBAD_ARBADSales_Combination;
insert into ss_rs_ts_aut_ap_digital_schema.DWS_Finance_FPA_ARBAD_ARBADSales_Combination
(
...
sum("0-60 Bad Debt Reserve") as "0-60 Bad Debt Reserve",
sum("61-90 Bad Debt Reserve") as "61-90 Bad Debt Reserve",
sum("91-120 Bad Debt Reserve") as "91-120 Bad Debt Reserve",
sum("121-200 Bad Debt Reserve") as "121-200 Bad Debt Reserve",
sum("211-300 Bad Debt Reserve") as "211-300 Bad Debt Reserve",
sum("301+ Bad Debt Reserve") as "301+ Bad Debt Reserve",
sum(BadDebt_31_60_budget_rate_amount) as BadDebt_31_60_budget_rate_amount,
sum(BadDebt_61_90_budget_rate_amount) as BadDebt_61_90_budget_rate_amount,
sum(BadDebt_91_120_budget_rate_amount) as BadDebt_91_120_budget_rate_amount,
sum(BadDebt_121_210_budget_rate_amount) as BadDebt_121_210_budget_rate_amount,
sum(BadDebt_211_300_budget_rate_amount) as BadDebt_211_300_budget_rate_amount,
sum(BadDebt_301_390_budget_rate_amount) as BadDebt_301_390_budget_rate_amount,
sum(BadDebt_391_480_budget_rate_amount) as BadDebt_391_480_budget_rate_amount,
sum(BadDebt_over_480_budget_rate_amount) as BadDebt_over_480_budget_rate_amount
...
from ss_rs_ts_aut_ap_digital_schema.DWD_Finance_FPA_ARBAD_BADAdjustment 
group by 
...
sum(coalesce(BadDebt_31_60_budget_rate_amount,0)) as BadDebt_31_60_budget_rate_amount,
sum(coalesce(BadDebt_61_90_budget_rate_amount,0)) as BadDebt_61_90_budget_rate_amount,
sum(coalesce(BadDebt_91_120_budget_rate_amount,0)) as BadDebt_91_120_budget_rate_amount,
sum(coalesce(BadDebt_121_210_budget_rate_amount,0)) as BadDebt_121_210_budget_rate_amount,
sum(coalesce(BadDebt_211_300_budget_rate_amount,0)) as BadDebt_211_300_budget_rate_amount,
sum(coalesce(BadDebt_301_390_budget_rate_amount,0)) as BadDebt_301_390_budget_rate_amount,
sum(coalesce(BadDebt_391_480_budget_rate_amount,0)) as BadDebt_391_480_budget_rate_amount,
sum(coalesce(BadDebt_over_480_budget_rate_amount,0)) as BadDebt_over_480_budget_rate_amount,
...
from ss_rs_ts_aut_ap_digital_schema.DWS_Finance_FPA_ARBAD_ARBADSales_Combination
group by
fiscal_yearmonth, --key
"Fiscal Week Number", --key
"Company Code", --key
...
coalesce(BadDebt_31_60_budget_rate_amount,0) as BadDebt_31_60_budget_rate_amount,
coalesce(BadDebt_61_90_budget_rate_amount,0) as BadDebt_61_90_budget_rate_amount,
coalesce(BadDebt_91_120_budget_rate_amount,0) as BadDebt_91_120_budget_rate_amount,
coalesce(BadDebt_121_210_budget_rate_amount,0) as BadDebt_121_210_budget_rate_amount,
coalesce(BadDebt_211_300_budget_rate_amount,0) as BadDebt_211_300_budget_rate_amount,
coalesce(BadDebt_301_390_budget_rate_amount,0) as BadDebt_301_390_budget_rate_amount,
coalesce(BadDebt_391_480_budget_rate_amount,0) as BadDebt_391_480_budget_rate_amount,
coalesce(BadDebt_over_480_budget_rate_amount,0) as BadDebt_over_480_budget_rate_amount,
coalesce(BadDebt_budget_rate_amount_total,0) as BadDebt_budget_rate_amount_total,
...
BadDebt_391_480_budget_rate_amount,
BadDebt_over_480_budget_rate_amount,
BadDebt_31_60_budget_rate_amount+BadDebt_61_90_budget_rate_amount+BadDebt_91_120_budget_rate_amount+BadDebt_121_210_budget_rate_amount+
BadDebt_211_300_budget_rate_amount+BadDebt_301_390_budget_rate_amount+BadDebt_391_480_budget_rate_amount+BadDebt_over_480_budget_rate_amount as BadDebt_budget_rate_amount_total,
Bad_Account_Occur_Amount,
Bad_Account_Collection_Amount,
Billing_Sales,
Billing_Margin
...
"start FYM",
"Expired FYM",
cast("TAX Rate" as float) as "TAX Rate"
from s3dataschema.ods_Finance_FPA_ARBAD_Taxrate
where Filename<>'filename'
) d 
on a.fiscal_yearmonth between d."start FYM" and d."Expired FYM";
...
--倒算collection
delete ss_rs_ts_aut_ap_digital_schema.DM_Finance_FPA_ARBAD_Balance;
insert into ss_rs_ts_aut_ap_digital_schema.DM_Finance_FPA_ARBAD_Balance
(
fiscal_yearmonth,
"Fiscal Week Number", 
"Company Code", 
...
BadDebt_391_480_budget_rate_amount,
BadDebt_over_480_budget_rate_amount,
BadDebt_budget_rate_amount_total,
...
"Company Code", 
"Sold To Customer Number"
from ss_rs_ts_aut_ap_digital_schema.DM_Finance_FPA_ARBAD_Balance
...
from
s3dataschema.ods_Finance_FPA_ARBAD_OpeningBalance 
where Filepath<>'filename' and bad_openning is not null and bad_openning<>'' 
...
select
distinct
Customer_Code as "Sold To Customer Number",
'BAD' as BAD_Flag
from ss_rs_ts_aut_ap_digital_schema.Dim_Finance_FPA_ARBAD_BADCustomerLimit
) c
on a."Sold To Customer Number"=c."Sold To Customer Number"
;
...
(
select
--'202401' AS fiscal_yearmonth,
--'202401' as "Fiscal Week Number",
companycode  as "Company Code", 
customer  as "Sold To Customer Number", --key
sum(bad_openning) as bad_openning
from
s3dataschema.ods_Finance_FPA_ARBAD_OpeningBalance 
where Filepath<>'filename' and bad_openning is not null and bad_openning<>'' 
group by companycode,customer
) c
...
delete ss_rs_ts_aut_ap_digital_schema.DM_Finance_FPA_ARBAD_BADBalance;
insert into ss_rs_ts_aut_ap_digital_schema.DM_Finance_FPA_ARBAD_BADBalance
(
fiscal_yearmonth,
--last_fiscal_year_week_id,
"Fiscal Week Number", 
